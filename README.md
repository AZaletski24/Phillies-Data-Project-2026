...
the report. Both scripts resolve their default paths relative to the repository, so they
...
panel gives **k of about 78 batters faced** of league-average prior, which independently
...
| **Blend of EB + ridge (shipped)** | **4.04 pp** | **0.417** |
